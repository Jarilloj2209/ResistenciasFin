        ...
        , ui(new Ui::Resistenciasven2)
{
    ...
    connect(ui->B5, &QRadioButton::clicked,
            this, &Resistenciasven2::bands_5);
    connect(ui->B4, &QRadioButton::clicked,
            this, &Resistenciasven2::bands_4);
...
///////////////Inicialiar_Bandas///////////////////////////////
void Resistenciasven2::bands_4() {
    cout<<"entrando"<<endl;
    Factoriai2 Fr;
    shared_ptr<Bandasi2> N4Bandas = Fr.getBanda(TipoBandai2 ::B4);
    N4Bandas->Inicializar();
}

void Resistenciasven2::bands_5() {
    cout<<"entrando"<<endl;
    Factoriai2 Fr;
    shared_ptr<Bandasi2> N5Bandas = Fr.getBanda(TipoBandai2 ::B5);
...
void Resistenciasven2::Col_Val() {
    ...
    FactoriaT2 Fr;
    shared_ptr<TBanda2> N4Bandas = Fr.getBanda(TipoBandaT2 ::B4);
    shared_ptr<TBanda2> N5Bandas = Fr.getBanda(TipoBandaT2 ::B5);
    if (b4==true)
    {
        N4Bandas->accion();
    }else if (b5==true){
